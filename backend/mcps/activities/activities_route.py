...
async def get_activities(uid: str = Query(..., description="User ID to fetch trip details")):
    """
    ...
    try:
        ...
        # Call the MCP to get activity suggestions
        ...
        logger.exception(f"An unexpected error occurred while fetching activity suggestions for UID: {uid}")
