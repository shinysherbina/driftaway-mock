...
@mcp.tool()
def find_hotels(uid: str) -> Dict[str, Any]:
    """
    Finds and enriches hotel listings based on user's trip details from Firestore.
    ...
    """
    logger.info(f"Tool 'find_hotels' called for UID: '{uid}' ")
